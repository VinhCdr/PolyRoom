...
public class ChonNgayGioJDialog extends javax.swing.JDialog {
    ...
    /**
     * Creates new form ChonNgayGioJDialog
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ChonNgayGioJDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ChonNgayGioJDialog dialog = new ChonNgayGioJDialog(new javax.swing.JFrame(), true);
