...
public class NMXemPhongJPanel extends javax.swing.JPanel {
    ...
    /**
     * Loading bản danh sách phòng và phòng đang mượn
     * @see #loadPhongDangMuon()
     * @see #loadTblPhong()
     */
    public void loading() {
        loadTblPhong();
    ...
    /**
     * Loading dữ liệu lên table phòng
     */
    ...
    /**
     * Loading dữ liệu phòng mà user đang mượn
     */
    ...
    /**
     * Show dialog phòng đang mượn lên để trả phòng
     * @see TraPhongJDialog
     */
    ...
    /**
     * Set thời gian để tìm phòng trống
     * @param txtBatDau Ô input sẽ nhận dữ liệu
     */
    ...
    /**
     * Set thời gian kết thúc để tìm phòng trống
     * @param txtBatDau Thời gian ở ô bắt đầu (để gợi ý thời gian kết thúc)
     * @param txtKetThuc Ô input sẽ nhận dữ liệu
     */
    ...
    /**
     * Bật form mượn phòng lên
     * @throws ToViewException Lỗi trên form
     * @see MuonPhongJDialog
     */
    private void muonPhong() throws ToViewException {
        ...
        if (selected == -1 || selected >= tblPhong.getRowCount()) {
            throw new ToViewException("Chưa chọn phòng muốn mượn");
        }
