...
public class DangNhapJDialog extends javax.swing.JDialog {
    ...
    /**
     * Nếu user có chọn nhớ tài khoản trước đó thì sẽ loading dữ liệu từ file lên ô input
     */
    ...
    /**
     * Lấy đối tượng tài khoản từ giao diện
     * @return Đối tượng tài khoản từ giao diện
     * @throws ToViewException Lỗi khi form để trống hoặc tương đương
     */
    ...
    /**
     * Hàm sẽ thực hiện việc xem có nhớ mật khẩu hay không, tự động dựa theo checkbox, sử dụng ở nút đăng nhập
     * @throws ToViewException Lỗi khi đọc ghi file
     */
